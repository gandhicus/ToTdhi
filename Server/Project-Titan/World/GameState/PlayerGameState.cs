    ...
    public class PlayerGameState
    {
        ...
        public void PlayerHitEnemy(uint time, uint playerProjId, uint enemyId)
        {
            ...
            if (projPos.DistanceTo(enemyPos) < proj.radius + enemyState.currentSnapshot.radius * enemyState.currentSnapshot.size) // Hit success!
            {
                ...
                var result = StatFunctions.ResolveDamage(
                    proj.damage,
                    playerState.currentSnapshot.GetAlternateStat(AlternateStatType.TrueDamageChance),
                    0,
                ...
                {
                    if (global::World.ServerSettings.AntiCheat)
        ...
        */
        ...
        public void EnemyHitPlayer(uint time, uint projId, uint clientTickId, Vec2 position)
        {
            ...
            playerState.Damage(time, proj.damage, proj.ownerInfo, proj.ownerId, proj.projectileId);
        ...
        public void EnemyHitPlayerAoe(uint time, AoeProjectileState aoeProj)
        {
            ...
            playerState.Damage(time, aoeProj.damage, aoeProj.ownerInfo, aoeProj.ownerId, aoeProj.projectileId);
