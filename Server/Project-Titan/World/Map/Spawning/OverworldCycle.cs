...
namespace World.Map.Spawning
{
    public class OverworldCycle
    {
        ...
        public ushort GetTitanSpawn(SoulGroup soulGroup)
        {
            ...
            var types = counts.Keys.Where(CanSpawnTitan).ToArray();
        ...
        private bool CanSpawnTitan(ushort titanType)
        {
            if (!titanDeathCount.TryGetValue(titanType, out var remainingKills)) return false;
