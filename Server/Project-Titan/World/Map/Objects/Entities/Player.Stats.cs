...
namespace World.Map.Objects.Entities
{
    public partial class Player
    {
        ...
        public void LevelUp()
        {
            ...
            {
                var amount = stat.increaseLoop[statLevelIncrement % stat.increaseLoop.Length];
                IncreaseStat(stat.type, amount, rawMaxHealthAmount: stat.type == StatType.MaxHealth);
            }
        ...
        public bool IncreaseStat(StatType type, int amount, bool rawMaxHealthAmount = false)
        {
            var level = GetLevel();
            ...
            if (type == StatType.MaxHealth && rawMaxHealthAmount)
            {
                amount = Math.Min(amount, allowedLevels * 10);
