    ...
    public class MarketItemTooltipMobile : MobileTooltip<MarketDisplay>, IDescriber
    {
        ...
        protected override void Load(Player player, bool owned, MarketDisplay obj)
        {
            ...
            */
            ...
            ItemDescriber.Describe(this, (TitanCore.Data.Entities.CharacterInfo)player.info, owned, obj.purchasableItem, player.GetStatFunctional(StatType.Attack), equippedFixedStats, includeItemForScaling, equippedFixedAlternateStats, player.GetScalingBonusStats(), player.GetScalingBonusAlternateStats(), equips);
        }
