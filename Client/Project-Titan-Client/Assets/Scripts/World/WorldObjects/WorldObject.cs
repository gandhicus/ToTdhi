...
public abstract class WorldObject : MonoBehaviour
{
    ...
    {
        ShowPlayerDamageAlert(amount, Color.red);
    }

    public void ShowPlayerDamageAlert(int amount, Color color)
    {
        if (playerDamageAlert == null)
        {
            playerDamageAlert = world.gameManager.objectManager.GetAlert(this, "-" + amount, color, false);
            playerDamage = amount;
        }
        else
        {
