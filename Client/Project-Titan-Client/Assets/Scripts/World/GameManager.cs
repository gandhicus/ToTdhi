...
public class GameManager : MonoBehaviour
{
    ...
    {
        world.GameChat("ToTdhi v" + NetConstants.Build_Version, ChatType.ClientInfo);
    ...
    {
        if (loadState == WorldLoadState.Loaded && IsSameMapInfo(this.mapInfo, mapInfo))
        {
            Debug.LogWarning("Ignoring duplicate MapInfo for already loaded world");
            return;
        }
    ...
    private bool IsSameMapInfo(TnMapInfo a, TnMapInfo b)
    {
        if (a == null || b == null) return false;
        return a.playerGameId == b.playerGameId &&
